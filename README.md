...
def normalize_database_url(database_url: str) -> str:
    ...
    This app uses psycopg v3, so SQLAlchemy URI should be:
    postgresql+psycopg://...
    """
...
def ensure_database_schema():
    ...
    # Extra safe migration for PostgreSQL if table already exists.
...
def register_routes(app):
    ...
    def index():
        ...
        # Same idea as material search:
        # default shows all links, then user can filter by categories or search.
