...
def normalize_database_url(database_url: str) -> str:
    ...
    This app uses psycopg v3, so SQLAlchemy URI should be postgresql+psycopg://
    """
...
def split_search_terms(search_text: str):
    """
    Search supports multiple words separated by:
    - , / \ ; + ، ؛
    Example:
    concrete - aramco - datasheet
    """
...
def register_routes(app):
    ...
    def index():
        ...
        # IMPORTANT:
        # Data table appears ONLY after choosing a category from dropdown
        # OR searching by title/category/tags/notes/url.
    ...
    def edit_link(link_id):
        ...
        categories = get_categories()
        stats = get_dashboard_stats()
        selected_category = edit_link_item.category or ""
        ...
        return render_template(
            ...
            search_terms=[],
            stats=stats,
            table_ready=bool(selected_category),
    ...
    @app.route("/health")
    def health():
        return {"status": "ok", "app": "link-library"}
