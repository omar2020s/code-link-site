...
from app import LinkItem, PendingCheckout, User, create_app, db  # noqa: E402
...
class AppFlowTests(unittest.TestCase):
    ...
    @patch("app.fetch_moyasar_payment")
    def test_verified_payment_activates_subscription(self, mock_fetch):
        ...
        with self.app.app_context():
            ...
            pending = PendingCheckout(
                ...
                amount_halalas=4900,
                currency="SAR",
                expires_at=__import__("app").utcnow() + __import__("datetime").timedelta(hours=1),
            )
